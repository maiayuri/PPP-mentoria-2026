...
|---|---|---|---|---|
| 1 | Registrar `CaseTeste@Exemplo.com`, depois registrar `caseteste@exemplo.com` | 409 (email já existe, case-insensitive) | 201 — os dois registros são aceitos como usuários diferentes | 🐞 Bug — [Issue #7](https://github.com/maiayuri/PPP-mentoria-2026-controle-de-gastos/issues/7) |
| 2 | Criar duas despesas (0.1 e 0.2) e conferir o resumo mensal | `totalGeral: 0.3` | `totalGeral: 0.30000000000000004` (erro de ponto flutuante) | 🐞 Bug — [Issue #8](https://github.com/maiayuri/PPP-mentoria-2026-controle-de-gastos/issues/8) |
| 3 | Criar despesa com `valor: 1e308` | 400 (fora de um limite razoável) | 201, aceito sem nenhuma validação de teto | 🐞 Bug — [Issue #9](https://github.com/maiayuri/PPP-mentoria-2026-controle-de-gastos/issues/9) |
| 4 | Criar despesa com `descricao` de 200.000 caracteres (> 100kb, limite padrão do `express.json`) | 413 (Payload Too Large) | 500 (Internal Server Error) — o middleware de erro não trata `PayloadTooLargeError` | 🐞 Bug — [Issue #10](https://github.com/maiayuri/PPP-mentoria-2026-controle-de-gastos/issues/10) (relacionada à [Issue #5](https://github.com/maiayuri/PPP-mentoria-2026-controle-de-gastos/issues/5)) |
